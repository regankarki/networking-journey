Title: Working With IPv4 Addresses — CCNA Lab
Overview
...
View R1’s interfaces using show ip interface brief
...
Configure IP addresses on PC1, PC2, and PC3
